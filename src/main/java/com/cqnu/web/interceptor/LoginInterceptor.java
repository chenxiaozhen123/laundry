...
//            throw LaundryException.getSessionTimeoutException("session timeout"); // 直接抛出异常
            ...
            if(uri.startsWith(ctx +"/admin")){
                ...
                builder = new StringBuilder();
                builder.append("<script type=\"text/javascript\" charset=\"utf-8\">");
                builder.append("alert(decodeURI('%E6%97%A0%E6%9D%83%E9%99%90%E8%AE%BF%E9%97%AE'));");
                builder.append("window.top.location.href=\"").append(request.getContextPath()).append("/login.html\"");
                builder.append("</script>");
            }
